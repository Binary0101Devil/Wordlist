...
Attack where the malicious script runs from another website through the web browser -- search box
- Stored XSS
Stored attacks are those where the injected script is permanently stored on the target servers -- comments , name or other
- DOM-Based XSS
...
<a:script xmlns:x="http://w3.org/1999/xhtml">alert(1)</a:script>
```
